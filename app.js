...
app.get('/bharathi', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  IBM. Send an email to bharnaya@in.ibm.com <center></h2>" );
    response.end();
...
app.get('/redirect', function(req, res) {
    ...
    app.listen(app.get('port'), function() {
        console.log("Node JS app is running at http://localhost:" + app.get('port') +"/bharathi");
      })
